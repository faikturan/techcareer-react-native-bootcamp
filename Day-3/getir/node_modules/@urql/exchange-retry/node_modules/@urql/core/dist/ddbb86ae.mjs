import { GraphQLError as r, Kind as e, parse as t, print as a } from "graphql";
...
var stringifyDocument = r => {
  var e = ("string" != typeof r ? r.loc && r.loc.source.body || a(r) : r).split(s).map(replaceOutsideStrings).join("");
  if ("string" != typeof r) {
