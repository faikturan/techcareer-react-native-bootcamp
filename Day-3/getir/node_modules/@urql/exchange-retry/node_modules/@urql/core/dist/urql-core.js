...
var fetchSource = require('./66832cef.js');
...
var ssrExchange = (params = {}) => {
  ...
  var ssr = ({
    ...
    var sharedOps$ = wonka.share(ops$);
    var forwardedOps$ = forward(wonka.filter(operation => !data[operation.key] || !!data[operation.key].hasNext || operation.context.requestPolicy === 'network-only')(sharedOps$)); // NOTE: Since below we might delete the cached entry after accessing
