...
import { View, Text, ScrollView, Dimensions, Settings } from 'react-native'
    ...
    <View>
        <View>
            ...
            containerStyle={(active) => ({
                ...
                variables.colors.darkPrimary: undefined,
            })} />
            ...
            animationType="spring" containerStyle={{ height: height}}>
                <TabView.Item>
        ...
        onBackdropPress={toggleDialog}>
            <Text style={styles.textDialog}>
                Please enter your address before adding an item to your basket.
            </Text>
